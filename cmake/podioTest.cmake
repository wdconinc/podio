...
function(PODIO_SET_TEST_ENV test)
  ...
  set(test_environment
    ...
    LD_LIBRARY_PATH=${PROJECT_BINARY_DIR}/src:$<$<TARGET_EXISTS:ROOT::Tree>:$<TARGET_FILE_DIR:ROOT::Tree>>:$<$<TARGET_EXISTS:SIO::sio>:$<TARGET_FILE_DIR:SIO::sio>>:$ENV{LD_LIBRARY_PATH}
